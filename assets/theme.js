...
(function() {
  ...
  theme.classes.FeaturedProduct = (function() {
    function FeaturedProduct(container1) {
      var _this;
      this.container = container1;
      this.eventListeners = bind(this.eventListeners, this);
      this.load = bind(this.load, this);
    ...
    FeaturedProduct.prototype.load = function() {
      var _this;
      _this = this;
    ...
    FeaturedProduct.prototype.eventListeners = function() {
      var _this;
      _this = this;
  ...
  theme.classes.ProductPage = (function() {
    ...
    ProductPage.prototype.addToCartListener = function() {
      ...
      if (_this.form.length > 0) {
        return _this.form.submit(function() {
          ...
          theme.partials.FrameworkCart.addItem($(this), function(pass, error) {
            if (pass) {
              return _this.renderCart();
            } else {
    ...
    ProductPage.prototype.renderCart = function() {
      var _this;
      _this = this;
      return theme.partials.FrameworkCart.renderCart(function() {
